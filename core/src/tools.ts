...
import * as abilities from './core-abilities';
...
const recallKnowledgeTool: Tool = {
...
const reflectAndImproveTool: Tool = {
...
// 获取能力清单
export function getAbilityManifest() {
  const categories = {
    learn: '🎓 学习能力',
    think: '🧠 思考能力',
    create: '✍️ 创作能力',
