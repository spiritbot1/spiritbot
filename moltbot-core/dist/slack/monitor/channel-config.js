import { applyChannelMatchMeta, buildChannelKeyCandidates, resolveChannelEntryMatchWithFallback, } from "../../channels/channel-config.js";
...
export function resolveSlackChannelConfig(params) {
    ...
    const candidates = buildChannelKeyCandidates(channelId, channelName ? `#${directName}` : undefined, directName, normalizedName);
