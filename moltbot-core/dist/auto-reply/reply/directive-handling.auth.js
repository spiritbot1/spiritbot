import { isProfileInCooldown, resolveAuthProfileDisplayLabel, resolveAuthStorePathForDisplay, } from "../../agents/auth-profiles.js";
...
export const resolveAuthLabel = async (provider, cfg, modelsPath, agentDir, mode = "compact") => {
...
export const formatAuthLabel = (auth) => {
