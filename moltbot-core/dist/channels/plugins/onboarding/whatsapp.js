...
import { listWhatsAppAccountIds, resolveDefaultWhatsAppAccountId, resolveWhatsAppAuthDir, } from "../../../web/accounts.js";
...
export const whatsappOnboardingAdapter = {
    ...
    configure: async ({ cfg, runtime, prompter, options, accountOverrides, shouldPromptAccountIds, forceAllowFrom, }) => {
        ...
        if (wantsLink) {
            ...
            await prompter.note(`Run \`${formatCliCommand("moltbot channels login")}\` later to link WhatsApp.`, "WhatsApp");
        }
