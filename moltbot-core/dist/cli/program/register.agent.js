...
import { agentsAddCommand, agentsDeleteCommand, agentsListCommand, agentsSetIdentityCommand, } from "../../commands/agents.js";
...
export function registerAgentCommands(program, args) {
    program
        .command("agent")
