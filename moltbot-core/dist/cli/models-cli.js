...
export function registerModelsCli(program) {
    ...
    models
        ...
        .option("--probe-profile <id>", "Only probe specific auth profile ids (repeat or comma-separated)", (value, previous) => {
