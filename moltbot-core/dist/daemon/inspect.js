...
import { GATEWAY_SERVICE_KIND, GATEWAY_SERVICE_MARKER, LEGACY_GATEWAY_SYSTEMD_SERVICE_NAMES, LEGACY_GATEWAY_WINDOWS_TASK_NAMES, resolveGatewayLaunchAgentLabel, resolveGatewaySystemdServiceName, resolveGatewayWindowsTaskName, resolveLegacyGatewayLaunchAgentLabels, } from "./constants.js";
...
function hasGatewayServiceMarker(content) {
    const lower = content.toLowerCase();
    return (lower.includes("moltbot_service_marker") &&
