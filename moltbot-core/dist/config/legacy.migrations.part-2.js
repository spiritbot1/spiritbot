import { ensureAgentEntry, ensureRecord, getAgentsList, getRecord, isRecord, mapLegacyAudioTranscription, mergeMissing, } from "./legacy.shared.js";
export const LEGACY_CONFIG_MIGRATIONS_PART_2 = [
    {
