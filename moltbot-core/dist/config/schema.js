...
const FIELD_HELP = {
    ...
    "gateway.controlUi.basePath": "Optional URL prefix where the Control UI is served (e.g. /moltbot).",
    ...
    "agents.defaults.memorySearch.store.path": "SQLite index path (default: ~/.clawdbot/memory/{agentId}.sqlite).",
    ...
    "plugins.installs": "CLI-managed install metadata (used by `moltbot plugins update` to locate install sources).",
