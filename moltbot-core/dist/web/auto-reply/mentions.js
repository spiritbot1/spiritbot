...
export function resolveMentionTargets(msg, authDir) {
...
export function isBotMentionedFromTargets(msg, mentionCfg, targets) {
    const clean = (text) => 
...
export function debugMention(msg, mentionCfg, authDir) {
...
export function resolveOwnerList(mentionCfg, selfE164) {
