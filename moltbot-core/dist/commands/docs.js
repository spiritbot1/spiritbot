...
export async function docsSearchCommand(queryParts, runtime) {
    ...
    const res = await runTool("mcporter", ["call", SEARCH_TOOL, "--args", payload, "--output", "text"], { timeoutMs: SEARCH_TIMEOUT_MS });
    if (res.code !== 0) {
