...
export function resolveUpdateAvailability(update) {
    ...
    const gitBehind = update.installKind === "git" && typeof update.git?.behind === "number"
        ? update.git.behind
        : null;
...
export function formatUpdateAvailableHint(update) {
