...
export async function scanStatus(opts, _runtime) {
    return await withProgress({
        ...
        const tailscaleDns = tailscaleMode === "off"
            ? null
            : await getTailnetHostname((cmd, args) => runExec(cmd, args, { timeoutMs: 1200, maxBuffer: 200_000 })).catch(() => null);
        const tailscaleHttpsUrl = tailscaleMode !== "off" && tailscaleDns
