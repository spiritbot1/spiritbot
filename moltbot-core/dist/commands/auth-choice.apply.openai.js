        ...
        try {
            ...
            if (creds) {
                ...
                if (params.setDefaultModel) {
                    ...
                    if (applied.changed) {
                        await params.prompter.note(`Default model set to ${OPENAI_CODEX_DEFAULT_MODEL}`, "Model configured");
                    }
                }
                else {
            ...
            await params.prompter.note("Trouble with OAuth? See https://docs.molt.bot/start/faq", "OAuth help");
        }
