...
export function formatGatewayChannelsStatusLines(payload) {
    ...
    const accountLines = (provider, accounts) => accounts.map((account) => {
        ...
        const inboundAt = typeof account.lastInboundAt === "number" && Number.isFinite(account.lastInboundAt)
            ? account.lastInboundAt
            : null;
        const outboundAt = typeof account.lastOutboundAt === "number" && Number.isFinite(account.lastOutboundAt)
