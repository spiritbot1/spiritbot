 ...
 */
export function getCachedSticker(fileUniqueId) {
 ...
 */
export function getAllCachedStickers() {
    const cache = loadCache();
...
export function getCacheStats() {
    ...
    const sorted = [...stickers].sort((a, b) => new Date(a.cachedAt).getTime() - new Date(b.cachedAt).getTime());
    return {
 ...
 */
export async function describeStickerImage(params) {
